...
mod tests {
    ...
    fn test_serialize_response() {
        let resp = ChatCompletionResponse::new("edge-1b", "Hello!".into(), 5, 2);
    ...
    fn test_serialize_chunk() {
        let chunk = ChatCompletionChunk::new_delta("edge-1b", "id-1", Some("Hi".into()), None);
    ...
    fn test_serialize_chunk_with_finish_reason() {
        let chunk = ChatCompletionChunk::new_delta("edge-1b", "id-99", None, Some("stop".into()));
        let json = serde_json::to_string(&chunk).unwrap();
    ...
    fn test_new_role_chunk() {
        let chunk = ChatCompletionChunk::new_role("edge-1b", "id-42");
        let json = serde_json::to_string(&chunk).unwrap();
