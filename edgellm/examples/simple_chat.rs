//! Minimal generation example using the edgellm umbrella crate.
//!
//! Run with:
//!   cargo run -p edgellm --example simple_chat --release -- path/to/model.gguf
//!
...
//! the user text. For Llama-style models, see edgellm-server's CLI which uses
...
use edgellm::core::generate::Generator;
use edgellm::core::model::Model;
use edgellm::core::sampling::SamplingParams;
use edgellm::loader::gguf::GgufFile;
use edgellm::loader::tokenizer::GgufVocab;
use edgellm::loader::weights::load_model_weights;
