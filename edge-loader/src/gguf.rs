...
use edge_core::config::{Architecture, ModelConfig};
use edge_core::model::{RawLayerWeights, RawWeight, WeightFormat};
...
impl GgufFile {
    ...
    /// raw bytes for the SIMD path.  This is the path `edge-web` uses so
...
mod tests {
    ...
    fn test_read_raw_weight_q4_1_metadata() {
        use edge_core::model::WeightFormat;
